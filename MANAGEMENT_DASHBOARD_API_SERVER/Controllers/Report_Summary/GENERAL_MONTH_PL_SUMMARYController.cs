...
{
    public class GENERAL_MONTH_PL_SUMMARYController : ApiController
    {
        private readonly GENERAL_MONTH_PL_SUMMARY_Repository _repository;

        public GENERAL_MONTH_PL_SUMMARYController()
        {
            ...
            _repository = new GENERAL_MONTH_PL_SUMMARY_Repository(connectionString);
        }

        // GET: GENERAL_MONTH_PL_SUMMARY
