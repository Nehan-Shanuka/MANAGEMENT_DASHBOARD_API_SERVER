...
{
    public class GENERAL_CUMULATIVE_SUMMARYController : ApiController
    {
        private readonly GENERAL_CUMULATIVE_SUMMARY_Repository _repository;

        public GENERAL_CUMULATIVE_SUMMARYController()
        {
            ...
            _repository = new GENERAL_CUMULATIVE_SUMMARY_Repository(connectionString);
        }

        // GET: GENERAL_CUMULATIVE_SUMMARY
