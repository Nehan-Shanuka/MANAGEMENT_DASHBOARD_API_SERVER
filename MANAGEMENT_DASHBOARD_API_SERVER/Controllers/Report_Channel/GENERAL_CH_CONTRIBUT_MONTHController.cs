...
{
    public class GENERAL_CH_CONTRIBUT_MONTHController : ApiController
    {
        private readonly GENERAL_CH_CONTRIBUT_MONTH_Repository _repository;

        public GENERAL_CH_CONTRIBUT_MONTHController()
        {
            ...
            _repository = new GENERAL_CH_CONTRIBUT_MONTH_Repository(connectionString);
        }

        // GET: GENERAL_CH_CONTRIBUT_MONTH
