...
{
    public class GENERAL_CH_MONTH_WISE_CONTRIController : ApiController
    {
        private readonly GENERAL_CH_MONTH_WISE_CONTRI_Repository _repository;

        public GENERAL_CH_MONTH_WISE_CONTRIController()
        {
            ...
            _repository = new GENERAL_CH_MONTH_WISE_CONTRI_Repository(connectionString);
        }

        // GET: GENERAL_CH_MONTH_WISE_CONTRI
