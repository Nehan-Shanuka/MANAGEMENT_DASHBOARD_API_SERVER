using MANAGEMENT_DASHBOARD_API_SERVER.Repositories.FireApp_Regional_Due_Summary;
using System;
...
namespace MANAGEMENT_DASHBOARD_API_SERVER.Controllers.FireApp_Regional_Due_Summary
{
    public class GeneralBranchDueForRegionalSummaryController : ApiController
    {
        private readonly GeneralBranchDueForRegionalSummary_Repository _repository;

        public GeneralBranchDueForRegionalSummaryController()
        {
        ...
        // GET: GeneralBranchDueForRegionalSummary
        public IHttpActionResult Get([FromUri] string p_year, string p_month, string p_region)
        {
            try
            {
