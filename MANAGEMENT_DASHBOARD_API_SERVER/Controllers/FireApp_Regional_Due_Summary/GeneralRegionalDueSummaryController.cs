...
{
    public class GeneralRegionalDueSummaryController : ApiController
    {
        private readonly GeneralRegionalDueSummary_Repository _repository;

        public GeneralRegionalDueSummaryController()
        {
        ...
        // GET: GeneralRegionalDueSummary
        public IHttpActionResult Get(string p_year, string p_month, string p_region)
        {
            try
            {
