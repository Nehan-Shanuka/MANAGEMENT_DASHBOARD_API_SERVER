...
{
    public class GENERAL_NMOTOR_CMLTV_SUMMARY_NController : ApiController
    {
        private readonly GENERAL_NMOTOR_CMLTV_SUMMARY_N_Repository _repository;

        public GENERAL_NMOTOR_CMLTV_SUMMARY_NController()
        {
            ...
            _repository = new GENERAL_NMOTOR_CMLTV_SUMMARY_N_Repository(connectionString);
        }

        // GET: GENERAL_NMOTOR_CMLTV_SUMMARY_N
