...
{
    public class GENERAL_MOTOR_PERF_CMLTVController : ApiController
    {
        private readonly GENERAL_MOTOR_PERF_CMLTV_Repository _repository;

        public GENERAL_MOTOR_PERF_CMLTVController()
        {
            ...
            _repository = new GENERAL_MOTOR_PERF_CMLTV_Repository(connectionString);
        }

        // GET: GENERAL_MOTOR_PERF_CMLTV
