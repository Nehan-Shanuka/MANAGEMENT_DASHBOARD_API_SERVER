...
{
    public class GENERAL_NMOTOR_PERF_CMLTVController : ApiController
    {
        private readonly GENERAL_NMOTOR_PERF_CMLTV_Repository _repository;

        public GENERAL_NMOTOR_PERF_CMLTVController()
        {
            ...
            _repository = new GENERAL_NMOTOR_PERF_CMLTV_Repository(connectionString);
        }

        // GET: GENERAL_NMOTOR_PERF_CMLTV
