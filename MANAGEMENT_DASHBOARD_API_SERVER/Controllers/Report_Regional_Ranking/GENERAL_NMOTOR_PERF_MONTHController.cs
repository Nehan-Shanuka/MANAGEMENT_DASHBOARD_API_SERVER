...
{
    public class GENERAL_NMOTOR_PERF_MONTHController : ApiController
    {
        private readonly GENERAL_NMOTOR_PERF_MONTH_Repository _repository;

        public GENERAL_NMOTOR_PERF_MONTHController()
        {
            ...
            _repository = new GENERAL_NMOTOR_PERF_MONTH_Repository(connectionString);
        }

        // GET: GENERAL_NMOTOR_PERF_MONTH
