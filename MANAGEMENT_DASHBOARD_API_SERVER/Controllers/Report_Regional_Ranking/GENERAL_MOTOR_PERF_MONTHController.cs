...
{
    public class GENERAL_MOTOR_PERF_MONTHController : ApiController
    {
        private readonly GENERAL_MOTOR_PERF_MONTH_Repository _repository;

        public GENERAL_MOTOR_PERF_MONTHController()
        {
            ...
            _repository = new GENERAL_MOTOR_PERF_MONTH_Repository(connectionString);
        }

        // GET: GENERAL_MOTOR_PERF_MONTH
