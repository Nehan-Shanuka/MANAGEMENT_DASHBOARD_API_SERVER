...
{
    public class GENERAL_MOTOR_PERF_RGBRCMLTVController : ApiController
    {
        public readonly GENERAL_MOTOR_PERF_RGBRCMLTV_Repository _repository;
        public GENERAL_MOTOR_PERF_RGBRCMLTVController()
        {
            ...
            _repository = new GENERAL_MOTOR_PERF_RGBRCMLTV_Repository(connectionString);
        }

        // GET: GENERAL_MOTOR_PERF_RGBRCMLTV
