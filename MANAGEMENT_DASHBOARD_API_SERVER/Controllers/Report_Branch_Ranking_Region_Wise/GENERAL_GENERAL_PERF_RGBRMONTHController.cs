...
{
    public class GENERAL_GENERAL_PERF_RGBRMONTHController : ApiController
    {
        public readonly GENERAL_GENERAL_PERF_RGBRMONTH_Repository _repository;
        public GENERAL_GENERAL_PERF_RGBRMONTHController()
        {
            ...
            _repository = new GENERAL_GENERAL_PERF_RGBRMONTH_Repository(connectionString);
        }

        // GET: GENERAL_GENERAL_PERF_RGBRMONTH
