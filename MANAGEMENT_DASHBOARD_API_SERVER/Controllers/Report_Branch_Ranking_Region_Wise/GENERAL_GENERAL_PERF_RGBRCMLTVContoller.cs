...
{
    public class GENERAL_GENERAL_PERF_RGBRCMLTVController : ApiController
    {
        public readonly GENERAL_GENERAL_PERF_RGBRCMLTV_Repository _repository;
        public GENERAL_GENERAL_PERF_RGBRCMLTVController()
        {
            ...
            _repository = new GENERAL_GENERAL_PERF_RGBRCMLTV_Repository(connectionString);
        }

        // GET: GENERAL_GENERAL_PERF_RGBRCMLTV
