using MANAGEMENT_DASHBOARD_API_SERVER.Repositories.FireApp_RM_Detail;
using System;
...
namespace MANAGEMENT_DASHBOARD_API_SERVER.Controllers.FireApp_RM_Detail
{
    public class GetGeneralListRMBMController : ApiController
    {
        private readonly GetGeneralListRMBM_Repository _repository;

        public GetGeneralListRMBMController()
        {
