using Dapper;
using Dapper.Oracle;
using MANAGEMENT_DASHBOARD_API_SERVER.Models.FireApp_Regional_Class_Summary;
...
namespace MANAGEMENT_DASHBOARD_API_SERVER.Repositories.FireApp_Regional_Class_Summary
{
    public class GenNonMotorClassRM_Repository
    {
        private readonly string _connectionString;

        public GenNonMotorClassRM_Repository(string connectionString)
        {
