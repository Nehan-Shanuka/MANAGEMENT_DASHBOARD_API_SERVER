using Dapper;
using Dapper.Oracle;
using MANAGEMENT_DASHBOARD_API_SERVER.Models.Report_Non_Motor_Summary;
...
namespace MANAGEMENT_DASHBOARD_API_SERVER.Repositories.Report_Non_Motor_Summary
{
    public class GENERAL_NMOTOR_CMLTV_SUMMARY_N_Repository
    {
        private readonly string _connectionString;

        public GENERAL_NMOTOR_CMLTV_SUMMARY_N_Repository(string connectionString)
        {
        ...
        public List<NonMotorSummary> CallStoredProcedure(int month)
        {
            using (var conn = new OracleConnection(_connectionString))
            {
                ...
                var result = conn.Query<NonMotorSummary>(
                    "SLIC_AGENT.GENERAL_NMOTOR_CMLTV_SUMMARY_N",
                    parameters,
